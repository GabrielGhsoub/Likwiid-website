...
const projectCatalog: Project[] = [
  ...
  },
  {
    ...
    previewAlt: 'Healthcare PDF API landing page',
    featured: true,
  ...
  },
  {
    ...
    images: [
      '/images/projects/salsa/studio-menu.webp',
      '/images/projects/salsa/dance-partner.webp',
    ],
    previewAlt: 'SalsaFlow WebXR studio menu on Meta Quest',
    featured: false,
